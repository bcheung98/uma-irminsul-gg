...
const ordinals = ["0", "1st", "2nd", "3rd", "4th", "5th"];

export const trainingEventContents: { [key: string]: string } = {
    has_meaningless_choices:
        "※ This event has meaningless choices; the rewards will be identical no matter what is selected.",
